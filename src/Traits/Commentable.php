...
trait Commentable
{
    ...
    {
        return $this->morphMany(Comment::class, 'commentable')->where('active','=', 1);
    }

    public function inactiveComments()
    {
        return $this->morphMany(Comment::class, 'commentable')->where('active', 0);
    }

    public function mainActiveComments()
    {
        return $this->morphMany(Comment::class, 'commentable')->where('active', 1)->where('parent_id', null);
    }
}
